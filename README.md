# image-build-cilium-clustermesh-apiserver

This repo builds a hardened image for the Cilium `clustermesh-apiserver` component that
...
- `rancher/hardened-cilium-clustermesh-apiserver`
...
- **Release**: on a published GitHub release (or manual dispatch), builds multi-arch images
  and pushes them to the Rancher Prime registry (`registry.rancher.com/rancher/hardened-cilium-clustermesh-apiserver`).
